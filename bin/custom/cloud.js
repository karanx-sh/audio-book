...
const cloudFront = new AWS.CloudFront.Signer(process.env.CF_ACCESS_KEY_ID, process.env.CF_PRIVATE_KEY);
    ...
    Statement: [
      {
        ...
        Condition: {
          ...
          DateLessThan: {
            "AWS:EpochTime": Math.floor(new Date().getTime() / 1000) + 60 * 60 * expiryHrs,
          },
          //   IpAddress: {
          //     "AWS:SourceIp": ip
          // }
